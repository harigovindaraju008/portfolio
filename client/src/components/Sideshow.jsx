...
export default class Sideshow extends Component {
  ...
  slideNext = () => {
    if (!this.state.transit) {
      const nextIndex =
        this.state.primaryIndex + 1 === this.props.imgs.length
          ? 0
          : this.state.primaryIndex + 1;
  ...
  render() {
    const indicators = this.props.imgs.map((img, i) => {
      const selectStyle =
    ...
    return (
      <div className="slideShow">
        ...
        <div className="slide" style={this.state.primaryStyle}>
          <img
            src={this.props.imgs[this.state.primaryIndex]}
            alt=""
            className="slideImg"
          />
        </div>
        <div className="slide" style={this.state.secondaryStyle}>
          <img
            src={this.props.imgs[this.state.secondaryIndex]}
            alt=""
            className="slideImg"
          />
        </div>
